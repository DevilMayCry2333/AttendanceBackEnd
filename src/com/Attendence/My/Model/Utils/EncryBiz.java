...
public class EncryBiz {
        ...
        public static void main(String[] args) {
            ...
            // 获取加盐后的MD5值
            String ciphertext = EncryBiz.getSaltMd5AndSha(plaintext);
            System.out.println("加盐后MD5：" + ciphertext);
            System.out.println("是否是同一字符串:" + EncryBiz.getSaltverifyMd5AndSha(plaintext, ciphertext));
        }
}
